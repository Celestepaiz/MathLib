...
//		Vector<Fraction> fractions = new Vector<Fraction>(Arrays.asList(new Fraction(1,8),new Fraction(1,2),new Fraction(1,4),new Fraction(1), new Fraction(-1), new Fraction(0)));
...
//		
		int[] zahlen = {2,4,8,
						...
						6,12,16,
						1,2,3};
		Matrix a = new Matrix(6,3, zahlen);
		print(a);
		a.eliminateMultipleRows();
		print(a);
		a.sortRows();
		print(a);
	}
